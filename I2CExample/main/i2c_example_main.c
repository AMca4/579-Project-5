...
#define ESP_SLAVE_ADDR APDS9960_I2C_ADDR
#endif
...
//volatile int *enable = APDS9960_ENABLE;
//volatile int regValue = 0x0F; 
//*enable = regValue;
...
static esp_err_t i2c_master_sensor_test(i2c_port_t i2c_num, uint8_t *data_h, uint8_t *data_l)
{
    ...
    *enable = regValue;
    ...
    i2c_master_write_byte(cmd, *enable, ACK_CHECK_EN); // Is this right??

    // Is the method to now stack i2c_master_write_byte with all register commands?
