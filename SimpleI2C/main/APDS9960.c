...
#include "stdlib.h"
#include "i2c_simple/Library/I2C.h"
...
//bool i2cInit(void) {
//   i2cDevice = I2cDevice();
//   return i2cDevice.i2cInit();
//}

void delay(long millis) {
   //i2cDevice.delay(millis);
   delay(millis);
}
...
bool wireWriteDataBlock( uint8_t reg, 
                                        ...
                                        unsigned int len)
{
   return writeDataBlock(reg, val, len);
}
